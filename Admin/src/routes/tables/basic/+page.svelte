...
<HeadTitle title="Basic Tables" />

<Breadcrumb title="Tables" pagetitle="Basic Tables" />
    ...
    <Col xl={6}>
        <Card>
            <CardBody>
                ...
                <div class="table-responsive">
                    <Table class="table-bordered border-primary mb-0">
        ...
        <Card>
            <CardBody>
                <div class="table-responsive">
                    ...
                    <p class="card-title-desc">
                        Table cells in <code>&lt;tbody&gt;</code> inherit their alignment from
    ...
    <Col xl={6}>
        <Card>
            <CardBody>
                ...
                <div class="table-responsive">
                    <Table class="table-striped table-bordered mb-0">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
...
<Row>
    <Col xl={6}>
        <Card>
            <CardBody>
                <h4 class="card-title">Hoverable</h4>
                <p class="card-title-desc">
...
<Row>
    <Col lg={6}>
        <Card>
            <CardBody>
                <h4 class="card-title">Contextual class</h4>
                <p class="card-title-desc">
                    Use contextual class to color table rows or individual cells.
                </p>
