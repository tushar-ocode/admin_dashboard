<script>
	...
	let currentFilter = 'one_year';
	export let chartColor;

	const overviewTimelineColors = getChartColorsArray(chartColor);
	let chart;
	const options = {
		series: [
			{
	...
	function filterChartdata(type) {
		// removeActive()
		switch (type) {
			case 'one_month':
				currentFilter = 'one_month';
				options.xaxis.min = new Date('28 Jan 2013').getTime();
				options.xaxis.max = new Date('27 Feb 2013').getTime();
				chart.updateOptions(options);
				break;
			case 'six_months':
				currentFilter = 'six_months';
				options.xaxis.min = new Date('27 Sep 2012').getTime();
				options.xaxis.max = new Date('27 Feb 2013').getTime();
				chart.updateOptions(options);
				break;
			case 'one_year':
				currentFilter = 'one_year';
...
<div id="overview-chart" class="apex-charts" dir="ltr">
	<div class="toolbar d-flex flex-wrap gap-2 justify-content-center">
		<Button
			...
			size="sm"
			id="one_month"
			class={currentFilter == 'one_month' ? 'active' : ''}
			on:click={() => filterChartdata('one_month')}
		>
			1M
		</Button>
		<Button
			...
			size="sm"
			id="six_months"
			class={currentFilter == 'six_months' ? 'active' : ''}
			on:click={() => filterChartdata('six_months')}
		>
			6M
		</Button>
		<Button
			...
			size="sm"
			id="one_year"
			class={currentFilter == 'one_year' ? 'active' : ''}
			on:click={() => filterChartdata('one_year')}>1Y</Button
		>
		<Button
			type="button"
			color="light"
			...
			on:click={() => filterChartdata('all')}>ALL</Button
		>
	</div>
	<div id="overviewchart" class="" dir="ltr" />
</div>
