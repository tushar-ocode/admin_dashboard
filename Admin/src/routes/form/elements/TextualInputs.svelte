...
<Card>
  <CardBody>
    <CardTitle class="h4">Textual inputs</CardTitle>
    <p class="card-title-desc">
      Here are examples of <code>.form-control</code> applied to each textual
      HTML5 <code>&lt;input&gt;</code> <code>type</code>.
    </p>
    ...
    <div class="mb-3 row">
      <label for="example-week-input" class="col-md-2 col-form-label">
        Week
      </label>
      <div class="col-md-10">
        <input
    ...
    <div class="mb-3 row">
      <label for="example-time-input" class="col-md-2 col-form-label">
        Time
      </label>
      <div class="col-md-10">
        <input
    ...
    <div class="mb-3 row">
      <label class="col-md-2 col-form-label" for="example-large">Select</label>
      <div class="col-md-10">
