...
<Breadcrumb title="Blog" pagetitle="Blog Details" />
								...
								<div class="mt-4">
									<div class="text-muted font-size-14">
										<p>
											...
											dolore magnam enim ad minima veniam quis
										</p>

										<p class="mb-4">
											Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit
											laboriosam, nisi ut aliquid ex ea reprehenderit qui in ea voluptate velit esse
										...
										<blockquote class="p-4 border-light border rounded mb-4">
											<div class="d-flex">
												<div class="me-3">
													<i class="bx bxs-quote-alt-left text-dark font-size-24" />
												</div>
												<div>
													<p class="mb-0">
														At vero eos et accusamus et iusto odio dignissimos ducimus qui
														blanditiis praesentium deleniti atque corrupti quos dolores et quas
									...
									<div class="mt-4">
										...
										<Form>
											...
											<div class="text-end">
												<Button type="submit" color="success" class="w-sm"> Submit </Button>
											</div>
										</Form>
									</div>
								</div>
