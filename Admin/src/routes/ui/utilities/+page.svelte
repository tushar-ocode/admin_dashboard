...
<Breadcrumb title="UI Elements" pagetitle="Utilities" />

<Row>
    <Col xl={12}>
        <Card>
            <CardBody>
                <CardTitle class="h4">Borders</CardTitle>
                <p class="card-title-desc">Use border utilities to add or remove an element’s borders.
...
<Row>
    <Col xl={6}>
        <Card>
            <CardBody>
                <CardTitle class="h4">Stacks - Vertical</CardTitle>
    ...
    <Col xl={6}>
        <Card>
            <CardBody>
                <CardTitle class="h4">Stacks - Horizontal</CardTitle>
                <p class="card-title-desc">Use <code>.vstack</code> to create vertical layouts. Stacked items are 
                full-width by default. Use <code>.gap-*</code> utilities to add space between items.</p>
    ...
    <Col xl="12">
        <Card>
            <CardBody>
                ...
                <Row class="text-center gy-3">
                    <div class="col">
                        <img src={img1} class="object-fit-contain border rounded avatar-xl d-block mx-auto mb-2" alt="...">
                        <code>.object-fit-contain</code>
                    </div>
                    <div class="col">
                        <img src={img1} class="object-fit-cover border rounded avatar-xl d-block mx-auto mb-2" alt="...">
                        <code>.object-fit-cover</code>
                    </div>
                    <div class="col">
                        <img src={img1} class="object-fit-fill border rounded avatar-xl d-block mx-auto mb-2" alt="...">
                        <code>.object-fit-fill</code>
                    </div>
                    <div class="col">
                        <img src={img1} class="object-fit-scale border rounded avatar-xl d-block mx-auto mb-2" alt="...">
                        <code>.object-fit-scale</code>
                    </div>
                    <div class="col">
                        <img src={img1} class="object-fit-none border rounded avatar-xl d-block mx-auto mb-2" alt="...">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="position-relative z-1">
                    <img src={avatar1} alt="" class="avatar-xxl rounded position-relative z-n1">
                    <img src={avatar2} alt="" class="avatar-xxl rounded position-relative z-0 ms-n5 mt-5">
                    <img src={avatar3} alt="" class="avatar-xxl rounded position-relative z-1 ms-n5">
                    <img src={avatar4} alt="" class="avatar-xxl rounded position-relative z-2 ms-n5 mt-5">
                    <img src={avatar5} alt="" class="avatar-xxl rounded position-relative z-3 ms-n5">
                </div>
            </div>
        </div>
    </div>
...
<Row>
    <Col lg={12}>
        <Card>
            <CardBody>
                <CardTitle class="h4">Shadows</CardTitle>
                <p class="card-title-desc">While shadows on components are disabled by default in Bootstrap and can be enabled via <code>$enable-shadows</code>, 
                you can also quickly add or remove a shadow with our <code>box-shadow</code> utility class. 
